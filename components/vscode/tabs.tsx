...
const routeToTab: Record<string, Tab> = {
  ...
  "/about/experience": { id: "tab-experience", path: "/about/experience", name: "experience.ts", icon: <File className="h-4 w-4 text-cyan-400" /> },
  "/projects/voice-agent": { id: "tab-project-voice-agent", path: "/projects/voice-agent", name: "voice-agent.tsx", icon: <File className="h-4 w-4 text-yellow-400" /> },
  "/projects/bugbot": { id: "tab-project-bugbot", path: "/projects/bugbot", name: "bugbot.tsx", icon: <File className="h-4 w-4 text-yellow-400" /> },
  ...
  "/projects/blockmind": { id: "tab-project-blockmind", path: "/projects/blockmind", name: "blockmind.jsx", icon: <File className="h-4 w-4 text-yellow-400" /> },
  "/projects/bablue": { id: "tab-project1", path: "/projects/bablue", name: "bablue.jsx", icon: <File className="h-4 w-4 text-yellow-400" /> },
  "/projects/chatwave": { id: "tab-project3", path: "/projects/chatwave", name: "chatapp.jsx", icon: <File className="h-4 w-4 text-yellow-400" /> },
